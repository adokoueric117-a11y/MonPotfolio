...
export async function AddExperienceAction(prevState:ActionState, formData: FormData): Promise<ActionState> {
    await requireAdmin();
    ...
    const image = formData.get('image') as File
        ...
        return{
            success: false,
            message: "Le champ titre et l'image sont obligatoires"
        }
    }
